 ...
 * @since        1
 */
abstract class TextTruncator_AdminPage_Page_Base extends TextTruncator_AdminPage_RootBase {
    ...
    public function __construct( $oFactory, array $aPageArguments ) {
        ...
        protected function _enqueueStyle() {
            $this->oFactory->enqueueStyle( 
                TextTruncator_Registry::getPluginURL( 'asset/css/' . $this->sPageSlug . '.css' ),
                $this->sPageSlug
            );    
        }    
