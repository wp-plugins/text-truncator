...
abstract class TextTruncator_AdminPageFramework_Registry_Base {
...
final class TextTruncator_AdminPageFramework_Registry extends TextTruncator_AdminPageFramework_Registry_Base {
    ...
    static public function setUp($sFilePath = __FILE__) {
        ...
        self::$sAutoLoaderPath = isset(self::$aClassFiles['TextTruncator_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['TextTruncator_AdminPageFramework_RegisterClasses'] : '';
        self::$bIsMinifiedVersion = class_exists('TextTruncator_AdminPageFramework_MinifiedVersionHeader');
    }
...
final class TextTruncator_AdminPageFramework_Bootstrap {
    public function __construct($sLibraryPath = __FILE__) {
        if (!$this->_isLoadable()) {
            return;
        }
        TextTruncator_AdminPageFramework_Registry::setUp($sLibraryPath);
        if (TextTruncator_AdminPageFramework_Registry::$bIsMinifiedVersion) {
            return;
        }
        include (TextTruncator_AdminPageFramework_Registry::$sAutoLoaderPath);
        new TextTruncator_AdminPageFramework_RegisterClasses(empty(TextTruncator_AdminPageFramework_Registry::$aClassFiles) ? TextTruncator_AdminPageFramework_Registry::$sDirPath : '', array('exclude_class_names' => array('TextTruncator_AdminPageFramework_MinifiedVersionHeader', 'TextTruncator_AdminPageFramework_BeautifiedVersionHeader',),), TextTruncator_AdminPageFramework_Registry::$aClassFiles);
        TextTruncator_AdminPageFramework_Registry::$bIsDevelopmentVersion = class_exists('TextTruncator_AdminPageFramework_InclusionClassFilesHeader');
    }
...
new TextTruncator_AdminPageFramework_Bootstrap(__FILE__);