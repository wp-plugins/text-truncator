 ...
 */
abstract class TextTruncator_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('TextTruncator_AdminPageFramework_RegisterClasses')) {
            return;
        }
        new TextTruncator_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
