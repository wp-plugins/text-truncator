 ...
 */
abstract class TextTruncator_AdminPageFramework_TaxonomyField extends TextTruncator_AdminPageFramework_TaxonomyField_Controller {
    ...
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $this->oProp = new TextTruncator_AdminPageFramework_Property_TaxonomyField($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
