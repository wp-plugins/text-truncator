 ...
 */
abstract class TextTruncator_AdminPageFramework_TaxonomyField_View extends TextTruncator_AdminPageFramework_TaxonomyField_Model {
    ...
    private function _getFieldsOutput($iTermID, $bRenderTableRow) {
        ...
        $this->oForm->format();
        $_oFieldsTable = new TextTruncator_AdminPageFramework_FormTable($this->oProp->aFieldTypeDefinitions, $this->_getFieldErrors(), $this->oMsg);
