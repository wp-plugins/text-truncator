 ...
 */
class TextTruncator_AdminPageFramework_WPUtility_URL extends TextTruncator_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(TextTruncator_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(TextTruncator_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $sRelativePath = TextTruncator_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
