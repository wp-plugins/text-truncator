 ...
 */
class TextTruncator_AdminPageFramework_FieldType_checkbox extends TextTruncator_AdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getEachCheckboxOutput(array $aField, $sKey, $sLabel) {
        $_oCheckbox = new TextTruncator_AdminPageFramework_Input_checkbox($aField['attributes']);
