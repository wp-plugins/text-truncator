 ...
 */
class TextTruncator_AdminPageFramework_FieldType_radio extends TextTruncator_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getEachRadioButtonOutput(array $aField, $sKey, $sLabel) {
        $_oRadio = new TextTruncator_AdminPageFramework_Input_radio($aField['attributes']);
