 ...
 */
class TextTruncator_AdminPageFramework_FieldType_size extends TextTruncator_AdminPageFramework_FieldType_select {
...
CSSRULES;
    ...
    private function _getUnitSelectInput(array $aField, array $aBaseAttributes, $isKey, $bMultiLabels) {
        ...
        $_oUnitInput = new TextTruncator_AdminPageFramework_Input_select($_aUnitAttributes + array('select' => $_aUnitAttributes));
