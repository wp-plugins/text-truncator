 ...
 */
abstract class TextTruncator_AdminPageFramework_FormField_Base extends TextTruncator_AdminPageFramework_FormOutput {
    public $aField = array();
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new TextTruncator_AdminPageFramework_Script_Widget;
        ...
        new TextTruncator_AdminPageFramework_Script_Utility;
        new TextTruncator_AdminPageFramework_Script_OptionStorage;
        new TextTruncator_AdminPageFramework_Script_AttributeUpdator;
        new TextTruncator_AdminPageFramework_Script_RepeatableField($this->oMsg);
        new TextTruncator_AdminPageFramework_Script_Sortable;
        new TextTruncator_AdminPageFramework_Script_RegisterCallback;
    }
