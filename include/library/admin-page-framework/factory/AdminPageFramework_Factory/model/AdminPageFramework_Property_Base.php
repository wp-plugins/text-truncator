 ...
 */
abstract class TextTruncator_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        $GLOBALS['aTextTruncator_AdminPageFramework'] = isset($GLOBALS['aTextTruncator_AdminPageFramework']) && is_array($GLOBALS['aTextTruncator_AdminPageFramework']) ? $GLOBALS['aTextTruncator_AdminPageFramework'] : array('aFieldFlags' => array());
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => TextTruncator_AdminPageFramework_Registry::NAME, 'sURI' => TextTruncator_AdminPageFramework_Registry::URI, 'sScriptName' => TextTruncator_AdminPageFramework_Registry::NAME, 'sLibraryName' => TextTruncator_AdminPageFramework_Registry::NAME, 'sLibraryURI' => TextTruncator_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => TextTruncator_AdminPageFramework_Registry::getVersion(), 'sDescription' => TextTruncator_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => TextTruncator_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => TextTruncator_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => TextTruncator_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => TextTruncator_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        if ('aScriptInfo' === $sName) {
            $this->sCallerPath = $this->sCallerPath ? $this->sCallerPath : TextTruncator_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
