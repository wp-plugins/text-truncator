 ...
 */
class TextTruncator_AdminPageFramework_PageLoadInfo_NetworkAdminPage extends TextTruncator_AdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new TextTruncator_AdminPageFramework_PageLoadInfo_NetworkAdminPage($oProp, $oMsg);
