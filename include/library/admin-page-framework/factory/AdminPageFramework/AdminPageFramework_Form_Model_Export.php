 ...
 */
abstract class TextTruncator_AdminPageFramework_Form_Model_Export extends TextTruncator_AdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new TextTruncator_AdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
