 ...
 */
abstract class TextTruncator_AdminPageFramework_Page_View_MetaBox extends TextTruncator_AdminPageFramework_Page_Model {
    ...
    private function _isMetaBoxAdded($sPageSlug = '') {
        if (!isset($GLOBALS['aTextTruncator_AdminPageFramework']['aMetaBoxForPagesClasses']) || !is_array($GLOBALS['aTextTruncator_AdminPageFramework']['aMetaBoxForPagesClasses'])) {
            return false;
        }
        ...
        foreach ($GLOBALS['aTextTruncator_AdminPageFramework']['aMetaBoxForPagesClasses'] as $sClassName => $oMetaBox) {
    ...
    public function _replyToAddMetaboxScript() {
        if (isset($GLOBALS['aTextTruncator_AdminPageFramework']['bAddedMetaBoxScript']) && $GLOBALS['aTextTruncator_AdminPageFramework']['bAddedMetaBoxScript']) {
            return;
        }
        $GLOBALS['aTextTruncator_AdminPageFramework']['bAddedMetaBoxScript'] = true;
