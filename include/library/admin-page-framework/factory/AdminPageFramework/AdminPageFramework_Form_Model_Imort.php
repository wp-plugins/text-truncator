 ...
 */
abstract class TextTruncator_AdminPageFramework_Form_Model_Import extends TextTruncator_AdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new TextTruncator_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
