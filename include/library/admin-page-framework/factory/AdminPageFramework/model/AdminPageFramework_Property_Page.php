 ...
 */
class TextTruncator_AdminPageFramework_Property_Page extends TextTruncator_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $GLOBALS['aTextTruncator_AdminPageFramework']['aPageClasses'] = isset($GLOBALS['aTextTruncator_AdminPageFramework']['aPageClasses']) && is_array($GLOBALS['aTextTruncator_AdminPageFramework']['aPageClasses']) ? $GLOBALS['aTextTruncator_AdminPageFramework']['aPageClasses'] : array();
        $GLOBALS['aTextTruncator_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
