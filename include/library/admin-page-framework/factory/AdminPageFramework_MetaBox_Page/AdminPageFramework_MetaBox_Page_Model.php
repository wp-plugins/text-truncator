 ...
 */
abstract class TextTruncator_AdminPageFramework_MetaBox_Page_Model extends TextTruncator_AdminPageFramework_MetaBox_Page_Router {
    ...
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        $this->oProp = new TextTruncator_AdminPageFramework_Property_MetaBox_Page($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
