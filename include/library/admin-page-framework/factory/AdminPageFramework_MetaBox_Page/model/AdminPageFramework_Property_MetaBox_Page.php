 ...
 */
class TextTruncator_AdminPageFramework_Property_MetaBox_Page extends TextTruncator_AdminPageFramework_Property_MetaBox {
    ...
    function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework', $sFieldsType = 'page_meta_box') {
        ...
        $GLOBALS['aTextTruncator_AdminPageFramework']['aMetaBoxForPagesClasses'] = isset($GLOBALS['aTextTruncator_AdminPageFramework']['aMetaBoxForPagesClasses']) && is_array($GLOBALS['aTextTruncator_AdminPageFramework']['aMetaBoxForPagesClasses']) ? $GLOBALS['aTextTruncator_AdminPageFramework']['aMetaBoxForPagesClasses'] : array();
        $GLOBALS['aTextTruncator_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        if (!isset($GLOBALS['aTextTruncator_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        if (!is_array($GLOBALS['aTextTruncator_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        foreach ($GLOBALS['aTextTruncator_AdminPageFramework']['aPageClasses'] as $__oClass) {
